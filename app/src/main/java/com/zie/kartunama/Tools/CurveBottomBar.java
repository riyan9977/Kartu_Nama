package com.zie.kartunama.Tools;
...
import com.zie.kartunama.R;

/**
 * Created by Ozzy on 23/12/2019.
 */

public class CurveBottomBar extends LinearLayout {
    private Path mPath;
    ...
    public CurveBottomBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CurveBottomBar(Context context, AttributeSet attrs, int defStyleAttr) {
